...
class MetricLogger:
    ...
    def log_episode(self, global_episode, total_reward, actor_loss, critic_loss, entropy_loss):
        ...
        with open(self.save_log, "a") as f:
            f.write(
                ...
                f"{entropy_loss:15.4f}{total_reward:15.2f}{time_since_last_record:15.3f}"
    ...
    def plot_metrics(self):
        ...
        for metric, name in zip(
            ["rewards", "actor_losses", "critic_losses", "entropy_losses"],
            ["rewards_plot", "actor_losses_plot", "critic_losses_plot", "entropy_losses_plot"],
        ):
            plt.clf()
